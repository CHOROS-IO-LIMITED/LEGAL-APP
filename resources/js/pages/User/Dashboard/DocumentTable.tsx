...
import { CheckCircle2, Clock, Eye, FileText, FolderOpen, SquarePen } from 'lucide-react';
...
> = {
    ...
    changes_requested: {
        ...
        pillClassName: 'rounded-full border px-2.5 py-1 text-xs bg-[#FEF3C7] text-[#B45309] border-[#FDE68A]',
        Icon: SquarePen,
        action: 'review',
    },
};
