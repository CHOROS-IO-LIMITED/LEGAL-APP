...
import Feature from './HowItWorks/Index';
        ...
        <div className="min-h-screen bg-[#FCF9F2] font-sans">
            ...
            <section className="mx-auto max-w-6xl px-8 py-20 text-center">
                ...
                <p className="mx-auto mb-10 max-w-2xl text-lg text-[#70665E] md:text-xl">
                    Explore our range of ready-to-use legal documents. Each template is AI-assisted, lawyer-reviewed, and fully customizable—so you
                    can create contracts, agreements, and forms in minutes.
                </p>
