...
> = {
    pending_approval: {
        ...
        pillClassName:
            'inline-flex items-center gap-1.5 rounded-full border border-[#F6DFAF] bg-[#FFF8E8] px-3 py-1 text-xs font-medium text-[#B7791F]',
        Icon: Clock3,
        actionLabel: 'Review',
    },
    signature: {
    ...
    rejected: {
        ...
        pillClassName:
            'inline-flex items-center gap-1.5 rounded-full border border-[#F3C9C9] bg-[#FFF1F1] px-3 py-1 text-xs font-medium text-[#B42318]',
        Icon: RotateCcw,
        actionLabel: 'Review',
    },
    completed: {
