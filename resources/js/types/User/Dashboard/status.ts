...
> = {
    draft: {
        label: 'Draft',
        Icon: SquarePen,
        pillClassName: 'inline-flex items-center gap-1.5  border border-[#DDD6FE] bg-[#F4F1FF] px-3 py-1 text-xs font-medium text-[#6D5BD0]',
        actionLabel: 'Review',
        action: 'review',
    },
    pending_approval: {
        ...
        Icon: Clock,
        pillClassName: 'inline-flex items-center gap-1.5  border border-[#F6E4B5] bg-[#FFF7E6] px-3 py-1 text-xs font-medium text-[#B7791F]',
        actionLabel: 'View',
        action: 'review',
    },
    signature: {
    ...
    rejected: {
        label: 'Rejected',
        Icon: XCircle,
        pillClassName: 'inline-flex items-center gap-1.5  border border-[#FECACA] bg-[#FEF2F2] px-3 py-1 text-xs font-medium text-[#DC2626]',
        actionLabel: 'Review',
        action: 'review',
    },
    completed: {
